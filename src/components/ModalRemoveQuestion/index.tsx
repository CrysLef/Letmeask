...
export function ModalRemoveQuestion({ onClose, questionId } : ModalProps) {
    ...
    return(
        <S.Container>
            <S.Modal>
                ...
                <S.Title>Excluir pergunta</S.Title>
                <S.Description>Tem certeza que você deseja excluir esta pergunta?</S.Description>
                <S.ButtonsWrapper>
                    <Button variant='cancel' onClick={onClose}>Cancelar</Button>
                    <Button variant='danger' onClick={handleClickDeleteButton}>Sim, excluir</Button>
                </S.ButtonsWrapper>
            </S.Modal>
        </S.Container>
    )
